...
#define MyAppName "NexDome V3 X2 PlugIn"
...
OutputBaseFilename=NexDomeV3_X2_Installer
...
[Files]
Source: "domelist NexDomeV3.txt";                       DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "domelist NexDomeV3.txt";                       DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "domelist64 NexDomeV3.txt"
; 32 bits
Source: "libNexDomeV3\Win32\Release\libNexDomeV3.dll";  DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
Source: "NexDomeV3.ui";                                 DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
Source: "NexDome.png";                                  DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
; 64 bits
Source: "libNexDomeV3\x64\Release\libNexDomeV3.dll";    DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "NexDomeV3.ui";                                 DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "NexDome.png";                                  DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
